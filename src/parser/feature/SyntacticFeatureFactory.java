...
public class SyntacticFeatureFactory implements Serializable {
    ...
    private final int numLabeledArcFeats;
    private int numWordFeats;            // number of word features

    public int getNumLabeledArcFeats() {
        return numLabeledArcFeats;
    }

    public int getNumWordFeats() {
        return numWordFeats;
    }
    ...
    private void addLabeledArcFeature(long code, float value, Collector mat) {
        int id = hashcode2int(code) & numLabeledArcFeats;
